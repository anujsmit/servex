...
export default function ServiceDetailsScreen() {
    ...
    const handleConfirmBooking = async () => {
        setSubmitting(true);
        try {
            // Determine the service type - this is the CRITICAL FIX
            const serviceType = service?.categoryName || categoryName || service?.name?.split(' ')[0].toLowerCase() || 'plumber';
            
            console.log('📦 Booking with type:', serviceType);
            console.log('📍 Location:', contextAddress);
            ...
            if (response.ok && data.success) {
                Alert.alert(
                    'Booking Submitted!',
                    `Your ${service?.name} service request has been submitted for admin approval.\n\nRequest ID: ${data.requestId}`,
                    [
                        {
                            text: 'View Status',
                            onPress: () => {
                                setBookingModalVisible(false);
                                router.push(`/service-status/${data.requestId}`);
                            },
                        },
                        {
                            text: 'Back to Home',
                            onPress: () => {
                                setBookingModalVisible(false);
                                router.push('/(protected)/(customer)/dashboard');
                            },
                        },
                    ]
                );
            ...
            <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.imageContainer}>
                    {serviceData.imageUrl ? (
                        ...
                        <LinearGradient colors={['#e67e22', '#f39c12']} style={styles.heroImagePlaceholder}>
                ...
                <View style={styles.infoContainer}>
                    ...
                    <View style={styles.section}>
                        ...
                        <TouchableOpacity style={styles.locationCard} onPress={() => setShowLocationModal(true)} activeOpacity={0.7}>
                            <View style={styles.locationIconContainer}>
                                <Ionicons name="location-sharp" size={24} color="#e67e22" />
                            </View>
                ...
                <View style={styles.footer}>
                    <View style={styles.priceContainer}>
                        ...
                        <Text style={styles.priceAmount}>रु {parseFloat(serviceData.price || '0').toLocaleString()}</Text>
                    </View>
                    <TouchableOpacity style={styles.bookButton} onPress={handleBookNow} disabled={isTokenRefreshing}>
                        {isTokenRefreshing ? (
                        ...
                        <View style={styles.modalContent}>
                            ...
                            <View style={styles.modalBody}>
                                <View style={styles.serviceSummary}>
                                    ...
                                    <Text style={styles.summaryPrice}>रु {parseFloat(serviceData.price || '0').toLocaleString()}</Text>
                                </View>
                                ...
                                <View style={styles.priceBreakdown}>
                                    ...
                                    <View style={styles.breakdownTotal}>
                                        ...
                                        <Text style={styles.totalAmount}>रु {parseFloat(serviceData.price || '0').toLocaleString()}</Text>
                                    </View>
                            ...
                            <View style={styles.modalFooter}>
                                ...
                                <TouchableOpacity style={styles.confirmButton} onPress={handleConfirmBooking} disabled={submitting}>
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.modalContainer}>
                        ...
                        <View style={styles.methodSelector}>
                            <TouchableOpacity style={[styles.methodButton, locationMethod === 'auto' && styles.methodButtonActive]} onPress={() => setLocationMethod('auto')}>
                                <Ionicons name="location" size={20} color={locationMethod === 'auto' ? '#e67e22' : '#64748b'} />
                                <Text style={[styles.methodText, locationMethod === 'auto' && styles.methodTextActive]}>Auto Detect</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.methodButton, locationMethod === 'manual' && styles.methodButtonActive]} onPress={() => setLocationMethod('manual')}>
                                <Ionicons name="create-outline" size={20} color={locationMethod === 'manual' ? '#e67e22' : '#64748b'} />
                                <Text style={[styles.methodText, locationMethod === 'manual' && styles.methodTextActive]}>Enter Manually</Text>
                            </TouchableOpacity>
                        </View>
                            ...
                            <View style={styles.autoLocationContainer}>
                                {!tempMarkerLocation ? (
                                    <View style={styles.detectContainer}>
                                        <MaterialIcons name="gps-fixed" size={48} color="#e67e22" />
                                        ...
                                        <TouchableOpacity style={styles.detectButton} onPress={detectCurrentLocation} disabled={isDetectingLocation}>
                                            {isDetectingLocation ? <ActivityIndicator color="#fff" /> : <><Ionicons name="location-sharp" size={20} color="#fff" /><Text style={styles.detectButtonText}>Detect Location</Text></>}
                                        </TouchableOpacity>
                                    </View>
                                ) : (
                                    <View style={styles.mapContainer}>
                                        ...
                                        <TouchableOpacity style={styles.recenterButton} onPress={detectCurrentLocation}>
                                            <Ionicons name="locate" size={20} color="#e67e22" />
                                        </TouchableOpacity>
                                    </View>
                                )}
                            </View>
                            ...
                            <View style={styles.manualLocationContainer}>
                                    ...
                                    <View style={styles.previewMapContainer}>
                                        <View style={styles.previewMapHeader}>
                                            ...
                                            <TouchableOpacity onPress={() => { setTempMarkerLocation(null); setSelectedLocation(null); }}>
                                                <Ionicons name="refresh" size={20} color="#e67e22" />
                                            </TouchableOpacity>
                                        </View>
                                        <MapView
                                ...
                                {!tempMarkerLocation && (
                                    <>
                                        ...
                                        <TouchableOpacity style={styles.submitAddressButton} onPress={handleManualAddressSubmit} disabled={isDetectingLocation || !manualAddress.trim()}>
                                            {isDetectingLocation ? <ActivityIndicator color="#fff" /> : <><Ionicons name="checkmark-circle" size={20} color="#fff" /><Text style={styles.submitAddressText}>Geocode Address Entry</Text></>}
                                        </TouchableOpacity>
                                    </>
                                )}
                            </View>
                        ...
                        <View style={styles.modalFooter}>
                            ...
                            <TouchableOpacity style={[styles.confirmButton, !tempMarkerLocation && styles.confirmButtonDisabled]} onPress={confirmLocation} disabled={!tempMarkerLocation}>
